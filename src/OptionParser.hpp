...
#ifndef LINKERFS_WARP_GEN_OATPP_OPTIONPARSER_HPP
#define LINKERFS_WARP_GEN_OATPP_OPTIONPARSER_HPP

#include <QCommandLineParser>

class OptionParser : QObject {
public:
    explicit OptionParser(QObject *parent);
